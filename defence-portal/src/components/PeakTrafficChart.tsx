...
const peakHoursData: PKD[] = [
    { time: '60:00', visitors: 12 },
...
export default function PeakTrafficChart():React.JSX.Element {
    return(
    <div className='bg-gray-900/40 border border-gray-800 rounded-xl p-5 lg:col-span-2'>
        <div className='mb-4'>
        ...
        <div className='h-64 w-full'>
            <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={peakHoursData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    ...
                    <XAxis dataKey="#64748b" fontSize={11} tickLine={false} />
